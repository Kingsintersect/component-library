import { MetaMaskIcon, OpraWalletIcon, BitCoinIcon, PayPalIcon, AppleIcon, AmericanExpressIcon, VisaIcon, MasterCardIcons, EthereumIcon } from '@components/icons/Icons';
