...
export const QuantityValueInput = () => {
    return (
        <div>
            ...
            <form className="max-w-xs mx-auto">
                ...
                <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">Please select the number of bedrooms.</p>
            </form>
