...
export const FacebookSignInButton = ({ children }: { children: ReactNode }) => {
    return (
        <>
...
export const TwitterSignInButtons = ({ children }: { children: ReactNode }) => {
    return (
        <>
...
export const GithubSignInButtons = ({ children }: { children: ReactNode }) => {
    return (
        <>
...
export const GoogleSignInButtons = ({ children }: { children: ReactNode }) => {
    return (
        <>
            <button type="button" className="text-white bg-[#f44242] hover:bg-[#b84a4a]/90 focus:ring-4 focus:outline-none focus:ring-[#782020]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#782020]/55 me-2 mb-2">
...
export const AppleSignInButtons = ({ children }: { children: ReactNode }) => {
    return (
